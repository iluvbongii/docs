...
<Note>As uxento continues to build, improve and update uDev - there may be a number of changes to the UI; if at any stage you wish to revert to the uDev Legacy UI - you may do so via the [Advanced Settings panel.](/uDev#advanced-settings%3A) </Note>
...
<Frame caption="Trade Coin can be Toggled Off/On 
">
  <img 
    src="/images/tradetog.png"
    alt="buysell"
    style={{
      width: '400%',
      borderRadius: '12px',
...
While you only need to use uDev with the wallet provided to you, you also have to option to import and manage multiple wallets. To do this, simply navigate to the Settings button and go to the **Dev Mode** panel. 

Once in the Dev Mode settings, you can scroll to the bottom to find a wallet management tab. 

<Frame caption="Dev Mode Wallet Management Tab">
  <img 
    src="/images/mngwal.png"
    alt="wallet manager"
    style={{
      width: '400%',
      borderRadius: '12px',
