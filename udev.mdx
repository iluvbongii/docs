...
Within the uDev Launch Panel, you can access a range of advanced settings to further fine tune your launch experience via uDev. 

Advanced Settings Access

These settings include:

Multi-Deploy: Easily set how many coins to deploy at once (max 4).

Deploy Priority Fee: Quickly change your priority fee when deploying coins. Higher = faster execution. 

Keyboard Shortcuts: Easily create and customise quick keyboard shortcuts for a range of quick actions i.e. Deploy Coin or Quick Deploy 3 SOL. 
